...
module.exports.handleEvent = async function ({
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😘' || _0x37dab3.body.toLowerCase() == "😘😘") {
    return _0x34fb9e.sendMessage("MeKo BHi kR L0o Naw Pappi 🥹", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥰' || _0x37dab3.body.toLowerCase() == "🥰🥰") {
    return _0x34fb9e.sendMessage("Aww Love You Naw Jaan 😘", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😍' || _0x37dab3.body.toLowerCase() == "😍😍") {
    return _0x34fb9e.sendMessage("ChaLl Hatt ThaRki", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤩' || _0x37dab3.body.toLowerCase() == '🤩🤩') {
    return _0x34fb9e.sendMessage("InSano Ki Ankhe HoTi Uh Ke Star Hain 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥳' || _0x37dab3.body.toLowerCase() == "🥳🥳") {
    return _0x34fb9e.sendMessage("0oo0o TeRa HaPpy BirthDay", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🙃' || _0x37dab3.body.toLowerCase() == "🙃🙃") {
    return _0x34fb9e.sendMessage("HaYe Rabba ☹️", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🙂' || _0x37dab3.body.toLowerCase() == "🙂🙂") {
    return _0x34fb9e.sendMessage("Awww Fake Smile Na Do Me Hu Naw Baby 🥺🥹🥹", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥲' || _0x37dab3.body.toLowerCase() == "🥲🥲") {
    return _0x34fb9e.sendMessage("Ase Muu BaNa KRr MT R0o 😒", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😊' || _0x37dab3.body.toLowerCase() == '😊😊') {
    return _0x34fb9e.sendMessage("AaJ Tuu BahUt KhuSh Ho 🫡", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '☺️' || _0x37dab3.body.toLowerCase() == "☺️☺️") {
    return _0x34fb9e.sendMessage("Ye Smile Na D0o Naw🥺", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😌' || _0x37dab3.body.toLowerCase() == "😌😌") {
    return _0x34fb9e.sendMessage("HaYe Mas0om", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😏' || _0x37dab3.body.toLowerCase() == '😏😏') {
    return _0x34fb9e.sendMessage("SasTa AttiTude Mtt dekHya kR MerY SamNy 😒😐", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😴' || _0x37dab3.body.toLowerCase() == "😴😴") {
    return _0x34fb9e.sendMessage("ChaL Ja NaHa kRr Aa", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😪' || _0x37dab3.body.toLowerCase() == '😪😪') {
    return _0x34fb9e.sendMessage("Ye kYa kR rahY Apni  Nose Sth🤔😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤤' || _0x37dab3.body.toLowerCase() == "🤤🤤") {
    return _0x34fb9e.sendMessage("Ral Mat Tapka MeKo ulTi Aa Rhi 🤮🤢", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😋' || _0x37dab3.body.toLowerCase() == "😋😋") {
    return _0x34fb9e.sendMessage("Yah ToTay Jesi Zuban Mt DiKha 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😛' || _0x37dab3.body.toLowerCase() == "😛😛") {
    return _0x34fb9e.sendMessage("Aww Gandyy 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😝' || _0x37dab3.body.toLowerCase() == '😝😝') {
    return _0x34fb9e.sendMessage("ABy Ankhe KhoL 0or ZuBan Ander kRr WRna KaT DunGa", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😜' || _0x37dab3.body.toLowerCase() == "😜😜") {
    return _0x34fb9e.sendMessage("BaRi MasTi ChaRi Chai TeRy Ko 1 Ankh Band KRrke ZuBan Bhir Aagyi 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤪' || _0x37dab3.body.toLowerCase() == "🤪🤪") {
    return _0x34fb9e.sendMessage("Ye Ajeeb_0_GaReeb Muu Na BaNa 😂 CarT0on 🤣", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥴' || _0x37dab3.body.toLowerCase() == "🥴🥴") {
    return _0x34fb9e.sendMessage("SasTa Nasha KRr LiYa LagTa Hai 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😔' || _0x37dab3.body.toLowerCase() == "😔😔") {
    return _0x34fb9e.sendMessage("JanU ChoR Gyaw Kya 😒😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥺' || _0x37dab3.body.toLowerCase() == '🥺🥺') {
    return _0x34fb9e.sendMessage("Hayye BabY Looty Ni Naw ye loo pioo 🍼🥺", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😬' || _0x37dab3.body.toLowerCase() == "😬😬") {
    return _0x34fb9e.sendMessage("Kis Ki Baja Di 🤨🧐", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😑' || _0x37dab3.body.toLowerCase() == "😑😑") {
    return _0x34fb9e.sendMessage("Wha Muu Ke SaTh Ankhe Be Band H0o GYi 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😐' || _0x37dab3.body.toLowerCase() == "😐😐") {
    return _0x34fb9e.sendMessage("TeRyy Muhh Py Elfiii Lgaw Di kYa ksi ny 😹", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😶' || _0x37dab3.body.toLowerCase() == '😶😶') {
    return _0x34fb9e.sendMessage("Nak T0o Thi Nhi Muu Be Gyb H0o GYa TeRa 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤐' || _0x37dab3.body.toLowerCase() == "🤐🤐") {
    return _0x34fb9e.sendMessage("Ab Tri Awaz Ai Na T0o Me Alfi Sy Band Krunga 😒", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤔' || _0x37dab3.body.toLowerCase() == "🤔🤔") {
    return _0x34fb9e.sendMessage("KashmiR AZaaD KrwanY Ka SocH RahY Tyaa 🙄🤔", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤫' || _0x37dab3.body.toLowerCase() == "🤫🤫") {
    return _0x34fb9e.sendMessage("Tri Yeh Ungli Tri He Nak Me DyDeni MaiNy 😒😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤭' || _0x37dab3.body.toLowerCase() == "🤭🤭") {
    return _0x34fb9e.sendMessage('😂😂😂', _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '🥱' || _0x37dab3.body.toLowerCase() == '🥱') {
    return _0x34fb9e.sendMessage("AJa BaBe MeLy Pas S0o Jaa😜", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤗' || _0x37dab3.body.toLowerCase() == "🤗🤗") {
    return _0x34fb9e.sendMessage("PhLe NaHa kRr Aa 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😱' || _0x37dab3.body.toLowerCase() == "😱😱") {
    return _0x34fb9e.sendMessage("KYa HuWa 😱 SheSha DeKh LiYa KYa 😳", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤨' || _0x37dab3.body.toLowerCase() == '🤨🤨') {
    return _0x34fb9e.sendMessage("Tu Hushyar Ban kRr Na Dekh Main Hun Naw 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🧐' || _0x37dab3.body.toLowerCase() == "🧐🧐") {
    return _0x34fb9e.sendMessage("Tu HaT Main DekhTa Hun 🧐🧐🧐", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😒' || _0x37dab3.body.toLowerCase() == "😒😒") {
    return _0x34fb9e.sendMessage("AsY DekH Rahy H00o MujH Mas0om ki Jan leNi Hai Tyaa 🥺", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🙄' || _0x37dab3.body.toLowerCase() == "🙄🙄") {
    return _0x34fb9e.sendMessage("UpeR TeRi PhupHi NaSreen Hai kYa 🙄", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😤' || _0x37dab3.body.toLowerCase() == '😤😤') {
    return _0x34fb9e.sendMessage("AbbY Ye kYa kR raHa hai 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😠' || _0x37dab3.body.toLowerCase() == "😠😠") {
    return _0x34fb9e.sendMessage("Ma nY Taaa tiYa Jo GhuSsa KRr RahY 🥺😢", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😡' || _0x37dab3.body.toLowerCase() == "😡😡") {
    return _0x34fb9e.sendMessage("Ma nY Taaa tiYa Jo GhuSsa KRr RahY 🥺😢", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '🤬' || _0x37dab3.body.toLowerCase() == '🤬🤬') {
    return _0x34fb9e.sendMessage("Aww 😐", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😞' || _0x37dab3.body.toLowerCase() == "😞😞") {
    return _0x34fb9e.sendMessage("Aww My lOve UpR UtHao Muh", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😓' || _0x37dab3.body.toLowerCase() == "😓😓") {
    return _0x34fb9e.sendMessage('☹️', _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😢' || _0x37dab3.body.toLowerCase() == "😢😢") {
    return _0x34fb9e.sendMessage("Looo Ni Melii Jàwn", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '☹️' || _0x37dab3.body.toLowerCase() == "☹️☹️") {
    return _0x34fb9e.sendMessage("awww baby🥺", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🙁' || _0x37dab3.body.toLowerCase() == '🙁🙁') {
    return _0x34fb9e.sendMessage("Aww taa Huwa☹️", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😕' || _0x37dab3.body.toLowerCase() == '😕😕') {
    return _0x34fb9e.sendMessage("🙁🙁🙁", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😮' || _0x37dab3.body.toLowerCase() == "😮😮") {
    return _0x34fb9e.sendMessage("OYyye MuuH BanD KRr WrNa MakHi Chali JaNi Hai😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😯' || _0x37dab3.body.toLowerCase() == "😯😯") {
    return _0x34fb9e.sendMessage('😲', _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😳' || _0x37dab3.body.toLowerCase() == "😳😳") {
    return _0x34fb9e.sendMessage("Kya hOgYa Inna AnkhY PhaR pHar k MujhY ku Dekh Rahy Ho 😳😳😳", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤯' || _0x37dab3.body.toLowerCase() == "🤯🤯") {
    return _0x34fb9e.sendMessage("TeRy Sar Me BumB Kis Ny PhoRa 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😖' || _0x37dab3.body.toLowerCase() == "😖😖") {
    return _0x34fb9e.sendMessage("ShaDeed Sad Ho kAaa BabY😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😣' || _0x37dab3.body.toLowerCase() == "😣😣") {
    return _0x34fb9e.sendMessage("😣😣😣", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😩' || _0x37dab3.body.toLowerCase() == '😫') {
    return _0x34fb9e.sendMessage("ChaL HaT NoTanKii😫😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😵' || _0x37dab3.body.toLowerCase() == "😵😵") {
    return _0x34fb9e.sendMessage("TeRi Eyes kiDr Gyye😟", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥶' || _0x37dab3.body.toLowerCase() == "sardi") {
    return _0x34fb9e.sendMessage("Aww BaBe  SarDi Lag Rhi T0o MeRe PaSs Ajao 🙈😜", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🥵' || _0x37dab3.body.toLowerCase() == "🥵🥵") {
    return _0x34fb9e.sendMessage("NaHa Le 😂🥶", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤢' || _0x37dab3.body.toLowerCase() == '🤮') {
    return _0x34fb9e.sendMessage("Aaaaa Tho0oo", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤧' || _0x37dab3.body.toLowerCase() == '😷') {
    return _0x34fb9e.sendMessage("Aryy BhaG Ja0o MeKo bHi BeemaR kR0o gaY 🥺", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤒' || _0x37dab3.body.toLowerCase() == '🤕') {
    return _0x34fb9e.sendMessage("Aww BaBe K0o Ta HuWa Idher Aow ThoRa Pyal L0o 😜💉💉💉", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😎' || _0x37dab3.body.toLowerCase() == "😎😎") {
    return _0x34fb9e.sendMessage("ChaSHma BHi New Lelo ab 🙂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😇' || _0x37dab3.body.toLowerCase() == "😇😇") {
    return _0x34fb9e.sendMessage("😇😇😇", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '🥸' || _0x37dab3.body.toLowerCase() == '🤓') {
    return _0x34fb9e.sendMessage("AiNeK WaLa JiN😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🤡' || _0x37dab3.body.toLowerCase() == '🤡🤡') {
    return _0x34fb9e.sendMessage("Aww S0o SweeT 😂 CarT0on", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😈' || _0x37dab3.body.toLowerCase() == '👿') {
    return _0x34fb9e.sendMessage("👽👽👽", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😹' || _0x37dab3.body.toLowerCase() == '😹😹') {
    return _0x34fb9e.sendMessage("AbbY BiLli 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '😺' || _0x37dab3.body.toLowerCase() == '😸') {
    return _0x34fb9e.sendMessage("😼😼😼", _0x50e4bb);
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '😼' || _0x37dab3.body.toLowerCase() == "😼😼") {
    return _0x34fb9e.sendMessage("Ye SaSTa AttiTuDe EdR MtT DekHa😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '💋' || _0x37dab3.body.toLowerCase() == "💋💋💋") {
    return _0x34fb9e.sendMessage("Yah PapPiYa Nhi kRr Kxh Kxh Nhi Bht KxH HoTa Hai 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '❤️' || _0x37dab3.body.toLowerCase() == '💚') {
    return _0x34fb9e.sendMessage("🖤🧡💜💙🤎🤍", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🧡' || _0x37dab3.body.toLowerCase() == '🤎') {
  ...
  ;
  if (_0x37dab3.body.toLowerCase() == '👻' || _0x37dab3.body.toLowerCase() == "👻👻") {
    return _0x34fb9e.sendMessage("Bh0oT Hi H0o", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🖕' || _0x37dab3.body.toLowerCase() == "🖕🖕") {
    return _0x34fb9e.sendMessage("Bund Me LeLe ApNi Bhens Chor 😂😂😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '💉' || _0x37dab3.body.toLowerCase() == '💊') {
    return _0x34fb9e.sendMessage("TumHy isKi ZaiDa Zarurat Hai 🤣", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == '🙈' || _0x37dab3.body.toLowerCase() == '🙊') {
    return _0x34fb9e.sendMessage("Sch Me Bander He Hai 😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == 'Chutia' || _0x37dab3.body.toLowerCase() == 'chutiya') {
    return _0x34fb9e.sendMessage("Tu Hai ChuTiya 🙂 Main T0o BoT Hun Naw🥺😂", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "oye" || _0x37dab3.body.toLowerCase() == 'oyee') {
    return _0x34fb9e.sendMessage("0ye HoYe 😈", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == 'Kkkkkk' || _0x37dab3.body.toLowerCase() == "jjj") {
    return _0x34fb9e.sendMessage("KYa ", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "Kkkkk" || _0x37dab3.body.toLowerCase() == 'Buraaa') {
    return _0x34fb9e.sendMessage(" H I J K L M N O P Q R S T U V W X Y Z 🙄", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == 'huh' || _0x37dab3.body.toLowerCase() == "hmm") {
    return _0x34fb9e.sendMessage("Kya Hmm 🙄ThaRki", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "acha" || _0x37dab3.body.toLowerCase() == "acha g") {
    return _0x34fb9e.sendMessage("Han Ji 🙄 Jaan", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "Janu" || _0x37dab3.body.toLowerCase() == "jan") {
    return _0x34fb9e.sendMessage("Bolo Naw MeRi JaN🥰💙", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "bot goes to sleep" || _0x37dab3.body.toLowerCase() == "bot goes to sleep") {
    return _0x34fb9e.sendMessage("I'm a bot, you're the one who should go to sleep <3", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "has the bot eaten yet" || _0x37dab3.body.toLowerCase() == "bot an comrade") {
    return _0x34fb9e.sendMessage("I'm full when I see you eat <3", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "does the bot love me" || _0x37dab3.body.toLowerCase() == "does the bot love me") {
    return _0x34fb9e.sendMessage("Yes <3", _0x50e4bb);
  }
  ;
  if (_0x37dab3.body.toLowerCase() == "does the bot have a brand" || _0x37dab3.body.toLowerCase() == "does the bot fall") {
    return _0x34fb9e.sendMessage("Yes <3", _0x50e4bb);
  }
  ;
  mess = "{name}";
  if (_0x37dab3.body.indexOf("Bot") == 0x0 || _0x37dab3.body.indexOf("bot") == 0x0) {
    var _0x410a01 = {
      'body': "\n       \n\n\n「 𓆩⃝" + _0x587418 + "𓆩๏𓆪 」  \n\n❥──────────────❥\n\n    " + _0x635ef1 + "\n\n★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀  ༄୧⍤⃝❥𝐊𝐚𝐬𝐡𝐢𝐟 𝐑𝐚𝐳𝐚❤️࿐"
    };
    return _0x34fb9e.sendMessage(_0x410a01, _0x50e4bb, _0x2f0052);
  }
  ;
};
